...
//@Disabled
public class TestPose2DTeleOpCommand extends CommandBase
{
    ...
    public TestPose2DTeleOpCommand(DriveSubsystem driveSubsystem, GoBildaPinpointDriver odo,
...
//nav calculates the power to set to each motor in a mecanum or tank drive. Use nav.getMotorPower to find that value.
    ...
    public boolean isFinished()
    {
        ...
        (this.nav.driveTo(m_odo.getPosition(), new Pose2DUnNormalized
                        (DistanceUnit.MM, 1000, 1000, UnnormalizedAngleUnit.DEGREES, -45),
                0.2, 0))
        {
            return true;
        }
